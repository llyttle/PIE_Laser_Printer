...
if __name__ == "__main__":
    G = Gantry()
    # T = ToolImage('totoro.jpg', res=200) # Import totoro.jpg, populate with n points
    # T = ToolVector('max_tshirt_line.hpgl')
    
    
    # T = ToolFile('mini_square.hpgl')
    # T = ToolImage('gradient.jpg', 200)
    ...
    if just_laser:
        ...
        # file 1:
        # T = ToolVector('laser_cad_graphics_tshirt1.hpgl')
        # DrawToolpath(G, T, 1, 50)
        # time.sleep(10)

        # file 2:
        T = ToolVector('chad.hpgl')
        DrawToolpath(G, T, 1, 100)
        # time.sleep(10)

        # # file 3:
        # T = ToolVector('jackass3.hpgl')
        # DrawToolpath(G, T, 0.25, 100)
        # # time.sleep(1)
